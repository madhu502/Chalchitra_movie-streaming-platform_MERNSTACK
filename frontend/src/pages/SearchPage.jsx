  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      if (error.response.status === 404) {
        ...
        toast.error("An error occurorange, please try again later");
      }
    }
  };
        ...
        <div className="flex justify-center gap-3 mb-4">
          <button
            className={`py-2 px-4 rounded ${
              activeTab === "movie" ? "bg-orange-600" : "bg-gray-800"
            } hover:bg-orange-700`}
          ...
          <button
            className={`py-2 px-4 rounded ${
              activeTab === "tv" ? "bg-orange-600" : "bg-gray-800"
            } hover:bg-orange-700`}
          ...
          <button
            className={`py-2 px-4 rounded ${
              activeTab === "person" ? "bg-orange-600" : "bg-gray-800"
            } hover:bg-orange-700`}
